...
- **世界聊天 @人 + 未读红点**：输入 `@` 呼出玩家列表、右键昵称/头像快捷 @人；只要还有别人发来的消息没看到就显示红点
- **世界红包**：把背包道具装进红包发到公屏，支持普通 / 专属（指定领取人，被指定人会收到定向提醒）/ 口令三种玩法；先到先得、每人限领1份；有效期（默认24小时）内没领完的份额自动退回发送者背包；聊天窗内可打开「我的红包」面板查看发出/领到/退回明细
