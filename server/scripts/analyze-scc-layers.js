...
const G = {
  ...
  ranking: ['handleFamiliarRank','isRankablePlayer','collectPlayerMarkerEntries','handleCombatPowerRanking','handleLevelRanking','handleTheoreticalDamageRanking','handleMaxDamageRanking','handleKillCountRanking','handleOnlineTimeRanking','handlePetRanking','secondsToTimeText','recordRankingStats','handleRanking','handleWealthRanking','formatRankingText'],
};
// 共享支撑层候选：被 ≥3 个组调用的底层辅助
const SHARED_CANDIDATES = ['advanceTask','incrementMarker','normalizeMarkers2','hasEquip','setMarkers2','itemName','itemType','getPlayerName','getCurrentMap','round2Text','millisecondsToText','formatUptime','randomInt','parseJsonArray','firstPositiveNumber','secondsToTimeText','formatGatherNumber','formatReverseNumber','resolveGatherCmd','updateOwnedSummonMode','hasTrainerAccess'];
