...
const G = {
  ...
  shop: ['handleTrade','handleHomeTrade','handleShop','handleActivityShop','handleDiamondShop','handleDataShop','handleAutoShop','handleGive','findMerchantInSummons','parseJsonArray','checkMerchantPurchaseGate','itemQuantity','formatMerchantItem','formatMerchantItems','addItemToCollection','getBackpackDisplayItems','hasEnoughResources','generateMerchantResource','generateMerchantInventory','buildMerchantInventory','purchaseMerchantItem','deductBackpackItem','handleRecipe','handleRecipeUnlock','handleReverse','readReverseProficiencies','reverseProficiency','setReverseProficiency','itemName','itemType','reverseValue','reverseItemFailure','reverseOne','reverseAllEligible','formatReverseNumber','formatReverseMenu','formatReverseBatchResult','formatReverseSingleResult','saveReverseResult'],
