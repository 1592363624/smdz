...
const G = {
  ...
  delayed: ['onModuleInit','recoverOrphanDelayedMarkers','handleReload','scheduleReloadCompletion','completeReload','handleRefill','completeRefill','handleSaveImage','handleStartSaveImage','handleStopSaveImage'], // P3-3 起为门面委托（注册块与启动迁移按 §4.2 永久留门面）
  inventory: ['handleInventory','getBackpackDisplayItems','handleResourceBag','handleSearchBag','handleSearchSafe','handleBagOps','handleUseItem','handleUseAllItems','getSeedCropName','handleUseSeed','handleViewDescription','handleViewMarkers','handleViewMarkers2','backpackQuantity','addBackpackItem'], // P3-6b 起为门面委托（getBackpackDisplayItems 属支撑层）
