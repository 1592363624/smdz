...
const G = {
  ...
  panel: ['buildPlayerInfo','buildPendingActions','buildActiveTasks','buildEquipmentSnapshot','formatBuffList','buildActiveBuffs','pushPlayerUpdate','doPushPlayerUpdate','pushMapUpdate','doPushMapUpdate','nextRev','getMapOverview','getNearbyPlayers','handleInfo','handleStatus','handleLookAround','handleViewPlayer','getDistance'],
  movement: ['handleMove','handleTeleport','handleFlyTo','findTravelVehicle','scheduleArrival','performArrival','applyPerformArrival','applyFoxAutoAttack','applyArrivalTriggers','shearPranaCubsOnArrival','migratePlayerAssetsOnMove','getMovementPathLength','handleExitVehicle'],
  shop: ['handleTrade','handleHomeTrade','handleShop','handleActivityShop','handleDiamondShop','handleDataShop','handleAutoShop','handleGive','findMerchantInSummons','parseJsonArray','checkMerchantPurchaseGate','itemQuantity','formatMerchantItem','formatMerchantItems','addItemToCollection','hasEnoughResources','generateMerchantResource','generateMerchantInventory','buildMerchantInventory','purchaseMerchantItem','deductBackpackItem','handleRecipe','handleRecipeUnlock','handleReverse','readReverseProficiencies','reverseProficiency','setReverseProficiency','itemName','itemType','reverseValue','reverseItemFailure','reverseOne','reverseAllEligible','formatReverseNumber','formatReverseMenu','formatReverseBatchResult','formatReverseSingleResult','saveReverseResult'],
  ...
  pet: ['handleViewPets','handlePetOps','handlePetRename','handlePetTransfer','handlePetDrive','handlePetFeed','handlePetSniff','handlePetAwaken','handlePetAttack','handlePetGoto','handlePetEquip','handleAllStop','handleAllActive','handleAllPassive','handleAllMilk','handleAllCommands','handleMilk','settleMilk','formatMilkRemaining','hasActiveMilkMarker','isMilkSpecial','getMilkAmount','addSummonMilkAffinity','handleShear','handleFollowAll','handleStartCapture','handleStopCapture','updateOwnedSummonMode','handleMassSummon'],
  ...
  delayed: ['onModuleInit','recoverOrphanDelayedMarkers','handleReload','scheduleReloadCompletion','completeReload','currentWeaponItem','equipmentSpecialSeq','hasEquippedSpecial','incrementMarker','normalizeMarkers2','handleRefill','completeRefill','handleSaveImage','handleStartSaveImage','handleStopSaveImage','handleStageStart','setMarkers2'],
  ...
  admin: ['finishNowForUser','handleAdminFinishNow','handleAdminCommand','getAdminHelpText','handleAdminStatus','handleAdminAnnounce','handleAdminSetWorldLevel','handleAdminGiveItem','handleAdminPlayerList','handleAdminToggleBan','handleAdminUpdateConfig','handleAdminUserList','handleAdminBanByQQ','handleAdminResetPlayer','handleAdminModifyPlayer','handleAdminIntervalMessage','handleAdminBroadcast','formatUptime'],
  ranking: ['handleFamiliarRank','isRankablePlayer','collectPlayerMarkerEntries','handleCombatPowerRanking','handleLevelRanking','handleTheoreticalDamageRanking','handleMaxDamageRanking','handleKillCountRanking','handleOnlineTimeRanking','handlePetRanking','secondsToTimeText','recordRankingStats','handleRanking','handleWealthRanking','formatRankingText','displayDamage'],
};
// 共享支撑层候选：被 ≥3 个组调用的底层辅助
const SHARED_CANDIDATES = ['incrementMarker','normalizeMarkers2','hasEquip','setMarkers2','itemName','itemType','getPlayerName','getCurrentMap','updateMapBuildings','roundText','round2Text','millisecondsToText','formatUptime','randomInt','parseJsonArray','firstPositiveNumber','displayDamage','secondsToTimeText','formatGatherNumber','formatReverseNumber','resolveGatherCmd','updateOwnedSummonMode','hasTrainerAccess','localTodayString'];
