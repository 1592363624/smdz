...
const SHARED_CANDIDATES = ['advanceTask','pushVehicleParts','buildNumberedMenu','incrementMarker','normalizeMarkers2','hasEquip','setMarkers2','itemName','itemType','itemQuantity','deductBackpackItem','getPlayerName','getCurrentMap','round2Text','millisecondsToText','formatUptime','randomInt','parseJsonArray','firstPositiveNumber','secondsToTimeText','formatGatherNumber','formatReverseNumber','resolveGatherCmd','updateOwnedSummonMode','hasTrainerAccess'];
