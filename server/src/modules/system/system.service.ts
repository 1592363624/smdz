/**
 * 系统信息/版本服务：读取部署清单 version.json 与更新检测配置，
 * 供前端检测"部署完成"并展示更新日志。
 * - version.json：由 GitHub Actions 每次部署前生成、随代码包部署到 {服务根目录}/version.json，
 *   含 commit SHA、部署时间、最近提交日志；本地开发无此文件时退化为 package.json 版本 + 空 SHA。
...
export class SystemService {
  ...
  /**
   * 获取部署版本信息与更新检测配置
   * @returns 含 version/sha/short/ref/deployedAt/message/commits/recentCommits/prevSha + settings
