...
async function main() {
  ...
  const commands = [
    ...
    { name: '我的载具', alias: 'my-vehicles', description: '跨地图列出名下所有载具（带呼叫快捷）', handlerKey: 'game', minRole: 'USER', sortOrder: 219 },
    ...
    { name: '查看装备', alias: 'view-equip', description: '查看已装备的装备详情(支持序号/名称)', handlerKey: 'game', minRole: 'USER', sortOrder: 240 },
    { name: '查看武器', alias: 'view-weapon', description: '查看已装备的武器详情(支持序号/名称)', handlerKey: 'game', minRole: 'USER', sortOrder: 240 },
    { name: '查看保险柜', alias: 'view-safe', description: '查看保险柜中的物品(支持序号/名称)', handlerKey: 'game', minRole: 'USER', sortOrder: 240 },
  ...
  const systemConfigs = [
    ...
    { key: 'game.wreckSpawnHour', value: '10', label: '废弃载具刷新小时', description: '每天在该整点小时自动刷新废弃载具（0-23）。默认 10。改后下次到点即生效，无需重启。设为 -1 可关闭自动刷新', type: 'number', group: 'game' },
    { key: 'game.wreckMaxCount', value: '3', label: '废弃载具全图上限', description: '所有地图上无主废弃载具的总数量上限；达到上限后不再自动刷新（管理员指令不受限）。默认 3，0=不限制', type: 'number', group: 'game' },
